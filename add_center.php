            ...
            <div class='row'>
             <div class='col-md-4'>
                       ...
                       <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            <label>Date of Expiy</label>
                            <input class="form-control"  type='date' name='center_doe' value="<?php echo $center_doe ?>">
                        </div>
                        <div class="form-group">
							<label>Ref By 
                    ...
                    <div class="col-md-4 mb-3">                  
                       ...
                       <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            <label>PIN Code (center) </label>
                            <textarea class="form-control" rows="3" name='pin_code'><?php echo $pin_code ?></textarea>
                        </div> 
                        <div class="form-group mb-3">
