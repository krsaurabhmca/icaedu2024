...
<style>
    ...
    td{font-size:18px;padding:4px;font-family:Trebuchet MS, arial;line-height:18px;font-weight:400;}
    #techpage{
        width:203mm;
        height:269mm;
        padding:0mm;
...
<div id='techpage'>
   <div id='printarea'>
      ...
      <table width='100%' border='0' >
				<tr>
				<td width='240px'> <label1> Registration No. </label> </td> 
				<td width='20px'> <label1>: </td>
				<td width='500px'> <?php echo $studentinfo['student_roll']; ?> </td>
				<td width='100px' rowspan='6' style='vertical-align:top;text-align:center;'width='230'>
					<img src='temp/upload/<?php  echo $studentinfo['student_photo']; ?>' alt ='<?php echo $studentinfo['student_photo']; ?>' width ='100' height='120' style='margin-top:-10px'/> 
				</td>
				...
				<?php
				   $course_id = courseinfo($sid,'id');
				    if($course_id!='184'){
        				echo "<td colspan='2'>". courseinfo($sid,'course_name') .'(' . courseinfo($sid,'course_code'). ')' ."</td>";
				    }
				    else{
				     echo  "<td colspan='2'>". courseinfo($sid,'course_name')."</td>"  ;
				    }
				?>
				</tr>
				<tr>
			...
			<table width='100%' height='30px;' border='0'>
				...
				<tr>
				    <td align='right'>
				        <div style='margin-right:30px;float:right;margin-bottom:10px;border:solid 0px red;'>
				            <img src='syllabus/irshad_sign.png' valign ='middle' width='130px'></div> 
				    </td>
				</tr>				
			</table>	
