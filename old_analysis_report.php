...
?>
 <!-- ============================================================== -->
            ...
            <div class="main-content">
                ...
                <h2 class="mb-4"><?php echo get_data('student',$student_id, 'name')['data']; ?>
                <button class='btn btn-primary btn-xs' onClick ='exportxls()'> Export </button>
				
                </h2>
				</div>
				<div class='col-3 text-right'>
					<a href='set_result?set_id=<?php echo $set_id; ?>' class='btn btn-info btn-xs' > Back to List</a>
				</div>
		</div>
		<div class="card mb-4">
        <div class="card-body">
                                    ...
                                    <thead>
                                        <tr>
                                            <td colspan='9' class='bg-dark text-light'>
                                               <center><b> <?php echo $set['set_name'] . " | ". $student['student_name'] ." | ".
