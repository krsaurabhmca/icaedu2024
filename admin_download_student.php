                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Print ID Card
	...
	<div class="card mb-4">
        ...
        <div class="card-body">
			        ...
			        <div class="table-responsive">
                        <form action='print_id.php' method='post' target='icard' >
                               <table id="data_tbl" class="table table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        $sql ="select * from student where center_id =$center_id "; //and status in( 'VERIFIED')"; 
                                        }
