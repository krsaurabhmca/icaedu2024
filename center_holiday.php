   ...
   <!-- ============================================================== -->
	...
	<div class="card ">
        ...
        <div class="card-body">
                ...
                <div class="col-md-4" >
                    <!-- Form Elements -->
                        <form action ='center_holiday' id='insert_frm' enctype='multipart/form-data'>
                ...
                <div class="col-lg-8">
                     ...
                     <table id="data_tbl" class="table table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                    <?php
                                    $query ="select * from center_holiday where center_id='$center_id' order by date('Y-m-d') asc";
                                    ...
                                    ?>
                                            <td align='right'>
                                            <?php echo btn_delete('center_holiday',$notice_id); ?>
                                            </td>
                                            </tr>
                                    <?php
                                    }
