...
$ct_name =" {$st_name}";
$ct ="{$gender} - {$student['student_father']} , Reg No. {$student['student_roll']} on successfully completion of {$course['course_name']} ( Duration - {$course['course_duration']} {$course['course_unit']} ) Course and secured {$result['percentage']} % with Grade {$result['grade']} *from our authorised Study Centre {$sc['center_name']}, {$sc['center_address']}, {$dist_name }, {$state_name}, Centre Code {$sc['center_code']} ";
