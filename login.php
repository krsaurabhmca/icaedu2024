                    ...
                    <div class="col-md-6 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            <div class="bg-primary bg-soft">
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4 text-light">
                                            <h5 class="text-primary text-light">Welcome Back !</h5>
                                            <h4  class="text-light"><?php echo $inst_name ?></h4>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0"> 
                                <div class="auth-logo">
                                    ...
                                    <a href="index" class="auth-logo-dark">
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="assets/images/apprise.jpg" alt="" class="rounded-circle" height="75">
                                            </span>
                                        </div>
                                    </a>
                                </div>
                                <div class="p-2">
                                    <form class="form-horizontal" id='login_frm'>
                                        ...
                                        <div class="mb-3">
                                            <label for="user_name" class="form-label text-light">Username</label>
                                            <input type="text" class="form-control" name="user_name" placeholder="Enter username" minlength='3' required>
                                        </div>
...
<!-- 
                                        ...
                                        <!--</div>-->
                                         ...
                                         <div class="mt-4 text-center">
                                            <span id='forget_password' class="text-light"><i class="mdi mdi-lock me-1"></i> Forgot your password? </span>
                                        </div>
                                    </form>
                                <!-- </div>  -->
