...
?>
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="form-group mb-3">
                 ...
                 <div class="form-group mb-3">
                    ...
                    <input class="form-control" type='number' placeholder="Course Fee" name='course_fee' value='<?php echo $course_fee ?>' required>
                </div>
                <?php } ?>
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control"  type='date' name='date_of_birth' max='2016-01-01' value='<?php echo $date_of_birth ?>'>
                </div>
                ...
                <div class="form-group mb-3">
                 ...
                 <div class="form-group mb-3">
                    ...
                    <input class="form-control"  type='tel' minlength='10' name='student_mobile' maxlength='10' value='<?php echo $student_mobile ?>' required>
                </div>
                <div class="form-group mb-3">
                    <label>Enter Email Id. </label>
                    <input class="form-control" placeholder="someone@email.com" name='student_email' type='email' value='<?php echo $student_email ?>' >
                </div>
                <?php if($user_type<>'CLIENT' && $isedit == 'yes') { ?>
                <div class="form-group mb-3">
