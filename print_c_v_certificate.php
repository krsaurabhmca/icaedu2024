...
@media print {
  ...
  @page {size: auto;}
			...
			<table width='1050px' height='420' border='0' id='certificate' >
				...
				$qrvalue = "Reg No :". studentinfo($sid,'student_roll')."Name". studentinfo($sid,'student_name') ."Certificate No". resultinfo($sid,'cer_no') . " http://icaedu.co.in/vocational-certificate-verification";
				$url ="http://chart.apis.google.com/chart?cht=qr&chs=120x120&chl=".$qrvalue."&chld=H|0"; 
				echo "<br><img src ='".qrcode($qrvalue)."' width ='90px' border='0'/> ";
				$student_photo = studentinfo($sid,'student_photo');
				?>
				</td>
				</tr>
				...
				<tr>
				<td colspan='3'>
			     <img src ='temp/upload/<?= $student_photo ?>' width ='90px' height='100px' align='right'/>
				<div style='width:800px;margin:auto;padding-top:30px;padding-bottom:20px;font-size:22px;'><br>
