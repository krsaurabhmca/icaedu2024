...
?>
                            ...
                            <div class="card">
                                <div class="card-header <?php echo $bgClr ?> font-weight-bold">
                                 ...
                                 <span class='float-right' style='float:right'>
                                        ...
                                        <?php 
                                        if($isedit == 'no' && $user_type =='CLIENT' and $wallet < $docs_fee)
                                        {
                                            echo "<span class='btn btn-danger btn-sm'>Your wallet amount is $wallet kindly recharge. </span>";
                                        }
                                        else{
                                            echo '<button class="btn btn-success btn-sm" id="update_btn" accesskey="s"> SAVE </button>';
                                        }
                                        ?>
                                    </span>
                                     </div>
                                  <div class="card-body">
            <form id='update_frm' action='add_student' > 
            <div class='row'>
            <div class="col-md-4 mb-3">
                ...
                <div class="form-group mb-3">
                    <label>Select Study Center <span class='badge bg-danger' id='wallet_amount' style='display:none'> </span>  </label>
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select select2" name='course_id' id='course_id'  required   >
                        <?php echo dropdown_list('course_details','id','course_code',$course_id,'course_name'); ?>
                    </select>
                ...
                <div class="form-group mb-3">
                    ...
                    <span class='badge bg-success'>
                         <?php
                         if($user_type=='CLIENT') echo lastid(centerid($user_name)); ?> </span>
                         <?php } ?>
                          <span id='rollNo'></span>
                     </label>
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control" placeholder="Student Name Here" name='student_name' value='<?php echo $student_name ?>' required>
                </div>
                    <div class="form-group mb-3">
                    <label>Enter Mother's Name</label>
                    <input class="form-control" placeholder="Mother's Name" name='student_mother' value='<?php echo $student_mother ?>' >
                </div>
                <div class="form-group mb-3">
                    <label>Enter Father's Name</label>
                    <input class="form-control" placeholder="Father's Name" name='student_father' value='<?php echo $student_father ?>' required>
                </div>
                
                <div class="form-group mb-3">
                    <label>Nationality</label>
                    <input class="form-control" placeholder="INDIAN" name='nationality' value='<?php echo $nationality ?>' required>
                </div>
            ...
            <div class="col-md-4 ">
                <div class="form-group mb-3">
                    ...
                    <select class="form-select" name='student_qualification'>
